...
Met `title` bepaal je de standaard MagicMirror-header boven het puntensaldo. Deze instelling hoort in `config/config.js` van MagicMirror en niet in `settings.json`.
